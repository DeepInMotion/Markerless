...
RAW_TRAIN_IMAGES_DIR = os.path.join(RAW_IMAGES_DIR, 'train') 
RAW_VAL_IMAGES_DIR = os.path.join(RAW_IMAGES_DIR, 'val') 
RAW_TEST_IMAGES_DIR = os.path.join(RAW_IMAGES_DIR, 'test') 
RAW_ANNOTATIONS_DIR = os.path.join(RAW_DATA_DIR, 'annotations')
RAW_ANNOTATION_FILE = os.path.join(RAW_ANNOTATIONS_DIR, 'annotations.csv')
...
BODY_PART_COLORS = ['#fff142', '#fff142', '#a8cf74', '#a8cf74', '#fff142', '#576ab1', '#5883c4', '#56bdef', '#f19718', '#d33592', '#d962a6', '#e18abd', '#f19718', '#8ac691', '#a3d091', '#bedb8f', '#7b76b7', '#907ab8', '#a97fb9']
FLIPPED_BODY_PARTS = ['head_top', 'nose', 'left_ear', 'right_ear', 'upper_neck', 'left_shoulder', 'left_elbow', 'left_wrist', 'thorax', 'right_shoulder', 'right_elbow', 'right_wrist', 'pelvis', 'left_hip', 'left_knee', 'left_ankle', 'right_hip', 'right_knee', 'right_ankle']
NUM_BODY_PARTS = len(BODY_PARTS)
SEGMENTS = [('head_top', 'nose'), ('nose', 'right_ear'), ('nose', 'left_ear'), ('nose', 'upper_neck'), ('upper_neck', 'thorax'), ('thorax', 'right_shoulder'), ('right_shoulder', 'right_elbow'), ('right_elbow', 'right_wrist'), ('thorax', 'left_shoulder'), ('left_shoulder', 'left_elbow'), ('left_elbow', 'left_wrist'), ('thorax', 'pelvis'), ('pelvis', 'right_hip'), ('right_hip', 'right_knee'), ('right_knee', 'right_ankle'), ('pelvis', 'left_hip'), ('left_hip', 'left_knee'), ('left_knee', 'left_ankle')]
