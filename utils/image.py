    ...
    def apply_transform(self, x, transform_parameters):
        ...
        if transform_parameters.get('flip_horizontal', False):
            if self.body_parts is None:
                ...
                temp_x = flip_axis(x, img_col_axis)
                x = [None for i in range(self.num_body_parts)]
                for n in range(self.num_body_parts):
                    flipped_body_part = self.flipped_body_parts[n]
                    corresponding_index = self.body_parts.index(flipped_body_part)
                    x[corresponding_index] = temp_x[...,n]
