...
def extract_point(conf, threshold, idx, confidence=False):
    ...
    bdp_factor = {0: 1.04, 1: 0.56, 2: 1.13, 3: 0.94, 4: 0.99, 5: 0.99, 6: 0.80, 7: 0.72, 8: 1.20, 9: 1.08, 10: 0.78, 11: 0.73, 12: 1.46, 13: 1.52, 14: 1.03, 15: 0.78, 16: 1.55, 17: 0.92, 18: 0.76, 19: 0.79, 20: 0.79, 21: 0.73, 22: 0.81, 23: 1.09, 24: 0.75, 25: 0.68, 26: 1.23, 27: 0.75, 28: 0.71}[idx]
    ...
    if conf_value < threshold:
        ...
        if soft_argmax:
            ...
            beta = 9.
            num_pix = int(np.round(2*sigma)) #Change 4*sigma to 2*sigma for InMotion
