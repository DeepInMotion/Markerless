...
def get_swish(inference=False, **kwargs):
    ...
    def swish(x):
        ...
        if backend.backend() == 'tensorflow' and not inference:
            try:
...
def mb_conv_block(inputs, block_args, activation, drop_rate=None, prefix='', inference=False):
...
def EfficientNet(width_coefficient,
    ...
    # Arguments
        ...
        inference: optional flag for whether operations should be standardized for inference mode
    # Returns
    ...
    bn_axis = 3 if backend.image_data_format() == 'channels_last' else 1
    activation = get_swish(inference=inference,
                           **kwargs)
...
def EfficientNetB0(include_top=True,
    ...
    return EfficientNet(1.0, 1.0, 224, 0.2,
                        ...
                        pooling=pooling, classes=classes, inference=inference,
                        **kwargs)
